...
RegisterCommand('30s',function(source,args,rawCommand)
    ...
    if vRP.request(nplayer,"Você deseja trintar",1000) then

    TriggerClientEvent("Notify",source,"importante","Importante","Contagem dos 30 segundos de ação",5000)
    TriggerClientEvent("Notify",nplayer,"importante","Importante","Contagem dos 30 segundos de ação",5000)

    TriggerClientEvent("progress",source,30000,"30s")
    TriggerClientEvent("progress",nplayer,30000,"30s")

        SetTimeout(30000,function()
            TriggerClientEvent("Notify",source,"sucesso","Sucesso","A Contagem dos 30 segundos de ação acabou",2000)
            TriggerClientEvent("Notify",nplayer,"sucesso","Sucesso","A Contagem dos 30 segundos de ação acabou",2000)
        end)
        end
 end)
---------------------------------------------------- 
