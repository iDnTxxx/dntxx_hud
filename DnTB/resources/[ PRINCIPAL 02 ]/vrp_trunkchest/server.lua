...
-- WEBHOOK
-----------------------------------------------------------------------------------------------------------------------------------------
local webhookbaucarro = "https://discord.com/api/webhooks/772298501077336095/jlndw6RKok6kqNS7d2pUv_5UScv6jusycEDQr1p9kFMrNBqm2Pe0bFkuSlR25E_ONNnw"
			...
			if items then
				...
				if parseInt(amount) > 0 then
					...
					if new_weight <= parseInt(max_veh) then
						...
						TriggerClientEvent("Notify",source,"negado","<b>Trunk</b> cheio.",8000)
					end
				else
