...
-- CONEXÃO
-----------------------------------------------------------------------------------------------------------------------------------
farM = Tunnel.getInterface("prod-vagos")
-----------------------------------------------------------------------------------------------------------------------------------
-- LOCAIS
-----------------------------------------------------------------------------------------------------------------------------------
local procMachine = {
	{ 1,344.66,-2028.97,22.36 },
	{ 2,-1106.20,4946.83,218.64 }
}
-----------------------------------------------------------------------------------------------------------------------------------
-- MENU
-----------------------------------------------------------------------------------------------------------------------------------
...
RegisterNUICallback("ButtonClick",function(data,cb)
	if data == "proc-folha" then
		TriggerServerEvent("proc-folha")
		SetNuiFocus(false)
		SendNUIMessage({ hidemenu = true })
		menuactive = false

	elseif data == "proc-coca" then
		TriggerServerEvent("proc-coca")
		SetNuiFocus(false)
		SendNUIMessage({ hidemenu = true })
		menuactive = false
