...
-- CONEXÃO
-----------------------------------------------------------------------------------------------------------------------------------
farM = Tunnel.getInterface("prod-grove")
-----------------------------------------------------------------------------------------------------------------------------------
-- LOCAIS
-----------------------------------------------------------------------------------------------------------------------------------
local procMachine = {
	{ 1,-159.06,-1630.32,34.16 },
	{ 2,1496.49,6394.82,20.78 }
}
-----------------------------------------------------------------------------------------------------------------------------------
-- MENU
-----------------------------------------------------------------------------------------------------------------------------------
...
RegisterNUICallback("ButtonClick",function(data,cb)
	if data == "proc-bateria" then
		TriggerServerEvent("proc-bateria")
		SetNuiFocus(false)
		SendNUIMessage({ hidemenu = true })
		menuactive = false

	elseif data == "proc-meta" then
		TriggerServerEvent("proc-meta")
		SetNuiFocus(false)
		SendNUIMessage({ hidemenu = true })
		menuactive = false
