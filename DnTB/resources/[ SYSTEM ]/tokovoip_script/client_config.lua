TokoVoipConfig = {
	...
	plugin_data = {
		...
		TSServer = "LastUltimate.unitycloud.host", -- TeamSpeak server address to be displayed on blocking screen
		...
		localNamePrefix = "[Last Ultimate] ", -- If set, this prefix will be added to the user's teamspeak display name
	}
};
